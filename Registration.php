<!DOCTYPE html>
<html>
<head><title>CMS Registration</title></head>
...
<body>
  <div class="Title-bar" >
    <button  class="w3-dark-grey" style=" border:none; margin-top:10px;"><a href="index.php"style="text-decoration:none; " >Back</a></button>
  ...
  <div class="register-page">
    ...
    <div class="form">
      <form class="register-form"  method="post">
        ...
        <Button class="w3-blue"type="submit" name="submit">Sign Up</button>
        <p class="message">Registered</p>
      </form>
...
die('Failed to connect to MySQL: '.mysqli_connect_error());
  ...
  if(isset($_POST['submit'])){
        ...
        if(empty($_POST ['username'])){
          $data_missing[]="Please enter Username ";
        ...
        if(empty($_POST ['password'])){
          $data_missing[] = " Please enterPassword ";
        }else{
        ...
        if(empty($_POST ['email'])){
          $data_missing[]="Please enter Email ";
        }else{
